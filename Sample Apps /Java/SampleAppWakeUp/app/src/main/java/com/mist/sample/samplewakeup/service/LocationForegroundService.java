...
import com.mist.sample.samplewakeup.Constants;
...
public class LocationForegroundService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            Notification notification = new NotificationCompat.Builder(this,"ChannelId3")
    ...
    private void createNotificationChannel() {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            NotificationChannel notificationChannel = new NotificationChannel("ChannelId3","Foreground notification", NotificationManager.IMPORTANCE_DEFAULT);
